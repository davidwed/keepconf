========================================================================
    APLICACIÓN DE CONSOLA: keepconf Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación keepconf.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la keepconf aplicación.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado keepconf.pch y un archivo de 
